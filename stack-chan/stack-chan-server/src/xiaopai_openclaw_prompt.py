...
常用表情 expression：calm、shy、thinking、speak1、speak2、heart、nod_soft、nod_down、happy_squint、happy_squint_soft。
常用动画 action：blink、wink、nod、nodding、heart_action、hearting、happy_dynamic、happy_squint_dynamic。使用 action 后不要立刻再接 face: calm，否则动画会被马上打断；如果需要收尾表情，把静态 face 放在 action 前面，或让 action 作为 sequence 最后一步。
