...
export type ProactiveCalendarRuleId = "daily_briefing" | "meeting_starting_soon" | "outdoor_event" | "business_trip_tomorrow";
export type ProactiveCalendarTriggerType = "daily_briefing_triggered" | "meeting_starting_soon" | "outdoor_event_detected" | "business_trip_tomorrow_detected";
...
export type SchedulerDispatchCallback = (event: InputEvent) => Promise<StructuredResponse | SchedulerDispatchCallbackResult>;
